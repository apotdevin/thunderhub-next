...
import { Title, Question, Text } from '../../components/typography/Styled';
    ...
    <>
      ...
      <Section color={themeColors.grey} padding={'19px 0 16px'}>
        ...
        <Text>
          ...
          (the "Site"). Your use of or access to the site is subject to the following Terms of Service (the
          "Agreement").
        </Text>
      </Section>
      <Section color={themeColors.grey} padding={'19px 0 16px'}>
        ...
        <Text>
          We are not responsible for any loss. LND, the ThunderHub website, and some of the underlying Javascript
          libraries we use are under active development. While every release is tested, there is always the possibility
          something unexpected happens that causes your funds to be lost. Please do not invest more than you are willing
          to lose. Please be careful.
        </Text>
      </Section>
      <Section color={themeColors.grey} padding={'19px 0 16px'}>
        <Question>3. Limitations</Question>
        <Text>
          In no event shall ThunderHub be liable for any damages (including, without limitation, damages for loss of
          data or profit, or due to business interruption) arising out of the use or inability to use the materials on
          our website, even if we or an authorized representative of ours has been notified orally or in writing of the
      ...
      <Section color={themeColors.grey} padding={'19px 0 16px'}>
        ...
        <Text>
          ...
          not warrant that any of the material on the website is accurate, complete or current. We may make changes to
          the material contained on the website at any time without notice. However we do not make any commitment to
          update the material.
        </Text>
      </Section>
      <Section color={themeColors.grey} padding={'19px 0 16px'}>
        ...
        <Text>
          We may revise these terms of service for the website at any time without notice. By using this website you are
      ...
      <Section color={themeColors.grey} padding={'19px 0 80px'}>
        ...
        <Text>
          Our Privacy Policy describes the way we do and do not collect, use, store, and disclose your personal
